...
public class SteamBoilerCategory extends GenericRecipeCategory<FluidHeatConversionRecipe> {
    ...
    public static List<SteamBoilerRecipe> getRecipes(IJeiHelpers jeiHelpers) {

        List<SteamBoilerRecipe> recipes = new ArrayList<>();
        ...
        recipes.add(new SteamBoilerRecipe(jeiHelpers, water, superheatedSteam,200,374,220,true));
        recipes.add(new SteamBoilerRecipe(jeiHelpers, distilledWater, superheatedSteam,200,374,220,false));
        return recipes;
    }
